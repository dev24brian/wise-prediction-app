...
class VipScreen3 extends StatefulWidget {
  const VipScreen3({super.key});

  @override
  State<VipScreen3> createState() => _VipScreen2State();
}

class _VipScreen2State extends State<VipScreen3> {
  @override
