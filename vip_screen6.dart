...
class VipScreen6 extends StatefulWidget {
  const VipScreen6({super.key});

  @override
  State<VipScreen6> createState() => _VipScreen2State();
}

class _VipScreen2State extends State<VipScreen6> {
  @override
